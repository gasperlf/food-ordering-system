...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase
     ...
     */
    public com.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus
     ...
     */
    public static com.food.ordering.system.kafka.order.avro.model
    ...
    public static class Builder
        ...
        private java.util.UUID orderId;
        private java.time.Instant createdAt;
        private com.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus
                orderApprovalStatus;
        private java.util.List<java.lang.String> failureMessages;
        ...
        private Builder(
            ...
            if (isValidValue(fields()[5], other.orderApprovalStatus)) {
                this.orderApprovalStatus =
                        data().deepCopy(fields()[5].schema(), other.orderApprovalStatus);
         ...
         * @return This builder.
         */
        public com.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel
                        .Builder
        ...
        public RestaurantApprovalResponseAvroModel build() {
            try {
                RestaurantApprovalResponseAvroModel record =
                        new RestaurantApprovalResponseAvroModel();
                record.id =
