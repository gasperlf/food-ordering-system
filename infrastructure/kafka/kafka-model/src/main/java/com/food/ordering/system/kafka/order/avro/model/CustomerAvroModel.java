...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase
     ...
     *     this class
     */
    public static CustomerAvroModel fromByteBuffer(java.nio.ByteBuffer b)
    ...
    private static final org.apache.avro.Conversion<?>[] conversions =
            new org.apache.avro.Conversion<?>[] {
                new org.apache.avro.Conversions.UUIDConversion(), null, null, null, null
            };
     ...
     */
    public static com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder
            newBuilder() {
    ...
    public static com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder
            newBuilder(
                    com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder
                            other) {
        if (other == null) {
            return new com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder();
        } else {
    ...
    /**
     * Creates a new CustomerAvroModel RecordBuilder by copying an existing CustomerAvroModel
     * instance.
     *
     ...
     */
    public static com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder
            newBuilder(com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel other) {
        if (other == null) {
            return new com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder();
        } else {
            return new com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder(
    ...
    public static class Builder
            extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
         ...
         */
        private Builder(
                com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder other) {
            super(other);
         ...
         * @return This builder.
         */
        public com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder setId(
         ...
         * @return This builder.
         */
        public com.food.ordering.system.kafka.order.avro.model.CustomerAvroModel.Builder
        ...
        public CustomerAvroModel build() {
            try {
                ...
                record.id =
                        fieldSetFlags()[0] ? this.id : (java.util.UUID) defaultValue(fields()[0]);
                record.username =
                        fieldSetFlags()[1]
                                ? this.username
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<CustomerAvroModel> WRITER$ =
            (org.apache.avro.io.DatumWriter<CustomerAvroModel>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<CustomerAvroModel> READER$ =
            (org.apache.avro.io.DatumReader<CustomerAvroModel>) MODEL$.createDatumReader(SCHEMA$);
