package net.ontopsolutions.food.ordering.system.kafka.consumer.config;

import net.ontopsolutions.food.ordering.system.kafka.config.data.KafkaConfigData;
import net.ontopsolutions.food.ordering.system.kafka.config.data.KafkaConsumerConfigData;
